  ...
  Post.find({}, function(err, posts){
    ...
    if (posts.length !== 0){
      ...
      res.render("home", {
        ...
        homecont: homeStartingContent,
        allposts: [{title: "No posts yet...", content: ""}]
...
app.get("/posts/:posttitle", function(req, res){
  ...
  var requestedPosttitle = _.toLower(req.params.posttitle);
  console.log(requestedPosttitle)

  Post.findOne({title: requestedPosttitle}, function(err, post){
     console.log(post)
     if (post!=null){
       res.render("post", {fpost: post});
     } else{
       res.render("post", {fpost: {title: "No posts found", content: ""}});
     }
